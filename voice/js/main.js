...
function setData() {
  ...
  return new Promise((resolve, reject) => {
    ...
    fetch('https://splatform.site/getAudioFile.php/', {
    method: "POST",
    headers: {
  ...
  .then(data => {
    ...
    getAudio = `https://splatform.site/getAudioFile.php?audio=1&secret=${data}&text=${encodeURIComponent(params.text)}&lang=${params.lang}&speed=${params.speed}&emotion=${params.emotion}&speaker=${params.vote}`;
